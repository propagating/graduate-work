...
Generate_WorleyNoise <- function(iTextureID, iPoints, fNoiseIntensity, szColorFunc, szDistanceFunc) {
    .Call(`_simpTex_Generate_WorleyNoise`, iTextureID, iPoints, fNoiseIntensity, szColorFunc, szDistanceFunc)
}

Generate_ReactionDiffusion <- function(iTextureID, iIterations, iSpawnPoints) {
    .Call(`_simpTex_Generate_ReactionDiffusion`, iTextureID, iIterations, iSpawnPoints)
}
